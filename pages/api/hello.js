...
export default function handler(req, res) {
  ...
  contract ${mysymbol} is Context, IERC20, Ownable {
    address public receiver;
      ...
      string private constant _name =  "${req.body.name}";
      string private constant _symbol = "${req.body.symbol}";
      uint8 private constant _decimals = ${req.body.decimal};
      ...
      uint256 private constant _tTotal = ${req.body.totalsupply};
      ...
      address payable private _developmentAddress = payable(${req.body.developeraddress}); 
      address payable private _marketingAddress = payable(${req.body.markertingaddress});
